...
import totemMain from "@/assets/squaree.png";
import totem1 from "@/assets/ecoo.png";
import totem2 from "@/assets/window.png";
import totem3 from "@/assets/touchh.png";
import totem4 from "@/assets/poshh.png";
          ...
          <div className="grid grid-cols-2 gap-2.5 md:gap-3 max-w-2xl mx-auto">
            {[
              ...
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <img src={tab.src} alt={`Tablet ${tab.label}`} className="w-full h-full object-cover" loading="lazy" />
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-[1fr_auto] gap-6 items-center mb-8">
          <div>
            ...
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
              Pantallas de papel electrónico ideales para señalética de espacios, de bajo consumo y máxima visibilidad.
            </p>
          </div>
